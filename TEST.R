# Preliminary Setup -------------------------------------------------------
#Data directories
dir_uv <- "/home/benny/PHD_DATA/UV/BF166//"
dir_cv <- "/home/benny/PHD_DATA/CV/TEST/"

# UV VIS ------------------------------------------------------------------
#load UV data.
UV <- Load_Spectra(dir_uv, starting_row_number = 20, threshold = 2, decimal_mark = ".")

#select ROI of UV data.
UV_cut <- select_columns_by_range(UV, 300:750)
...
#UV_range
Plot_UV_range(UV_cut_smooth, scan_dir = "oxidative")
...
#plot UV by range
Plot_UV_range(SEC$oxidative, range = NULL, start_range = -1 , end_range = 0, scan_dir = "oxidative")

#plot UV by range
Plot_UV_range(SEC$oxidative, range = NULL, start_range = -0.05 , end_range = 0.5, scan_dir = "oxidative")
#plot UV by range
Plot_UV_range(SEC$reductive, range = NULL, start_range = 0.3, end_range = 1, scan_dir = "reductive")
